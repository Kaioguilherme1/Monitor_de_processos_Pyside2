...
################################################################################
## Form generated from reading UI file 'Monitor_processos_IUiBevVC.ui'
##
...
"background-color: none;")
        ...
        self.FDados.setMaximumSize(QSize(300, 170))
...
"background: none;")
        ...
        self.FDdireito.setMaximumSize(QSize(800, 800))
...
"background-color: none;")
        ...
        self.FDados_3.setMaximumSize(QSize(300, 170))
...
"background: none;")
        ...
        self.FDdireito_3.setMaximumSize(QSize(800, 800))
...
"background-color: none;")
        ...
        self.FDados_2.setMaximumSize(QSize(300, 170))
...
"background: none;")
        ...
        self.FDdireito_2.setMaximumSize(QSize(800, 16777215))
...
"background: none;")
        ...
        self.Atualizar = QPushButton(self.page_home)
        self.Atualizar.setObjectName(u"Atualizar")
        self.Atualizar.setMaximumSize(QSize(250, 40))
        font5 = QFont()
...
"    }")
        ...
        self.verticalLayout_12.addWidget(self.Atualizar, 0, Qt.AlignHCenter)

        self.Botton = QFrame(self.page_home)
        self.Botton.setObjectName(u"Botton")
        self.Botton.setMinimumSize(QSize(0, 0))
        ...
        self.Credit = QLabel(self.Botton)
        self.Credit.setObjectName(u"Credit")
        font6 = QFont()
        font6.setFamily(u"Arial")
        self.Credit.setFont(font6)
        self.Credit.setStyleSheet(u"color: #47ACDE;")
        self.Credit.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_7.addWidget(self.Credit)

        self.label_2 = QLabel(self.Botton)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Credit.setText(QCoreApplication.translate("MainWindow", u"created by kaio Guilherme.", None))
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"                                                                                                   V 1.1", None))
    # retranslateUi
